...
/// auto generated
/// Builds and executes requests for operations under \group\{groupid}\vault\random
class RandomRequestBuilder extends BaseRequestBuilder<RandomRequestBuilder> {
    ...
    RandomRequestBuilder(Map<String, dynamic> pathParameters, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/group/{groupid}/vault/random{?length*}", pathParameters) ;
    /// Instantiates a new [RandomRequestBuilder] and sets the default values.
    ///  [rawUrl] The raw URL to use for the request builder.
    ///  [requestAdapter] The request adapter to use to execute the requests.
    RandomRequestBuilder.withUrl(String rawUrl, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/group/{groupid}/vault/random{?length*}", {RequestInformation.rawUrlKey : rawUrl}) ;

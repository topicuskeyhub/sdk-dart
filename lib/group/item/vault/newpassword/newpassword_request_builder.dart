...
/// auto generated
/// Builds and executes requests for operations under \group\{groupid}\vault\newpassword
class NewpasswordRequestBuilder extends BaseRequestBuilder<NewpasswordRequestBuilder> {
    ...
    NewpasswordRequestBuilder(Map<String, dynamic> pathParameters, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/group/{groupid}/vault/newpassword{?strategy*}", pathParameters) ;
    /// Instantiates a new [NewpasswordRequestBuilder] and sets the default values.
    ///  [rawUrl] The raw URL to use for the request builder.
    ///  [requestAdapter] The request adapter to use to execute the requests.
    NewpasswordRequestBuilder.withUrl(String rawUrl, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/group/{groupid}/vault/newpassword{?strategy*}", {RequestInformation.rawUrlKey : rawUrl}) ;

...
/// auto generated
/// Builds and executes requests for operations under \account\{accountid}\vault\record
class RecordRequestBuilder extends BaseRequestBuilder<RecordRequestBuilder> {
    ...
    /// Gets an item from the ApiSdk.account.item.vault.record.item collection

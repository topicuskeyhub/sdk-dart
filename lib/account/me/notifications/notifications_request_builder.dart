...
class NotificationsRequestBuilder extends BaseRequestBuilder<NotificationsRequestBuilder> {
    ...
    NotificationsRequestBuilder(Map<String, dynamic> pathParameters, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/account/me/notifications{?lang*,requestMailKey*,requestsToRetainIds*}", pathParameters) ;
    /// Instantiates a new [NotificationsRequestBuilder] and sets the default values.
    ///  [rawUrl] The raw URL to use for the request builder.
    ///  [requestAdapter] The request adapter to use to execute the requests.
    NotificationsRequestBuilder.withUrl(String rawUrl, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/account/me/notifications{?lang*,requestMailKey*,requestsToRetainIds*}", {RequestInformation.rawUrlKey : rawUrl}) ;

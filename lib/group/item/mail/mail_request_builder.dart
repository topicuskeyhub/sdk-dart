...
import '../../../models/group/group_mail.dart';
...
class MailRequestBuilder extends BaseRequestBuilder<MailRequestBuilder> {
    ...
    /// Send a mail to the managers or members of the group identified by the id.
    ///  [body] The request body
    ///  [requestConfiguration] Configuration for the request such as headers, query parameters, and middleware options.
    Future<void> postAsync(GroupMail body, [void Function(RequestConfiguration<DefaultQueryParameters>)? requestConfiguration]) async {
    ...
    ///  [body] The request body
    ///  [requestConfiguration] Configuration for the request such as headers, query parameters, and middleware options.
    RequestInformation toPostRequestInformation(GroupMail body, [void Function(RequestConfiguration<DefaultQueryParameters>)? requestConfiguration]) {

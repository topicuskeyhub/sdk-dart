...
class NewpasswordRequestBuilder extends BaseRequestBuilder<NewpasswordRequestBuilder> {
    ...
    NewpasswordRequestBuilder(Map<String, dynamic> pathParameters, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/account/{accountid}/vault/newpassword{?strategy*}", pathParameters) ;
    /// Instantiates a new [NewpasswordRequestBuilder] and sets the default values.
    ///  [rawUrl] The raw URL to use for the request builder.
    ///  [requestAdapter] The request adapter to use to execute the requests.
    NewpasswordRequestBuilder.withUrl(String rawUrl, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/account/{accountid}/vault/newpassword{?strategy*}", {RequestInformation.rawUrlKey : rawUrl}) ;

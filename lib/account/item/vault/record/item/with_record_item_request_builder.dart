...
/// auto generated
/// Builds and executes requests for operations under \account\{accountid}\vault\record\{recordid}
class WithRecordItemRequestBuilder extends BaseRequestBuilder<WithRecordItemRequestBuilder> {
    ...
    WithRecordItemRequestBuilder(Map<String, dynamic> pathParameters, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/account/{accountid}/vault/record/{recordid}{?additional*}", pathParameters) ;
    /// Instantiates a new [WithRecordItemRequestBuilder] and sets the default values.
    ///  [rawUrl] The raw URL to use for the request builder.
    ///  [requestAdapter] The request adapter to use to execute the requests.
    WithRecordItemRequestBuilder.withUrl(String rawUrl, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/account/{accountid}/vault/record/{recordid}{?additional*}", {RequestInformation.rawUrlKey : rawUrl}) ;

...
/// auto generated
/// Builds and executes requests for operations under \client\{clientid}\vault\record\{recordid}\move
class MoveRequestBuilder extends BaseRequestBuilder<MoveRequestBuilder> {
    ...
    MoveRequestBuilder(Map<String, dynamic> pathParameters, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/client/{clientid}/vault/record/{recordid}/move", pathParameters) ;
    /// Instantiates a new [MoveRequestBuilder] and sets the default values.
    ///  [rawUrl] The raw URL to use for the request builder.
    ///  [requestAdapter] The request adapter to use to execute the requests.
    MoveRequestBuilder.withUrl(String rawUrl, RequestAdapter requestAdapter) : super(requestAdapter, "{+baseurl}/client/{clientid}/vault/record/{recordid}/move", {RequestInformation.rawUrlKey : rawUrl}) ;
